...
public class CharsetMapping {
    ...
    static {
        ...
        MysqlCharset[] charset = new MysqlCharset[] {
                ...
                new MysqlCharset(MYSQL_CHARSET_NAME_sjis, 2, 0,
                        new String[] { "SHIFT_JIS", "Cp943", "WINDOWS-31J" }), // SJIS is alias for SHIFT_JIS, Cp943 is
                                                                               // rather a cp932 but we map it to sjis
                                                                               // for years
                ...
                new MysqlCharset(MYSQL_CHARSET_NAME_eucjpms, 3, 0, new String[] { "EUC_JP_Solaris" },
                        new ServerVersion(5, 0, 3)),

                new MysqlCharset(MYSQL_CHARSET_NAME_gb18030, 4, 0, new String[] { "GB18030" },
                        new ServerVersion(5, 7, 4)),

                new MysqlCharset(MYSQL_CHARSET_NAME_euckr, 2, 0, new String[] { "EUC-KR" }),

                new MysqlCharset(MYSQL_CHARSET_NAME_latin1, 1, 1,
                        new String[] { "Cp1252", "ISO8859_1" }),
                ...
                new MysqlCharset(MYSQL_CHARSET_NAME_keybcs2, 1, 0, new String[] { "Cp852" }), // Kamenicky encoding
                                                                                              // usually known as Cp895
                                                                                              // but there is no
                                                                                              // official cp895
                ...
                new MysqlCharset(MYSQL_CHARSET_NAME_utf8mb4, 4, 1, new String[] { "UTF-8" }), // "UTF-8 = *> 5.5.2
                                                                                              // utf8mb4"
        ...
        for (int i = 1; i < MAP_SIZE; i++) {
            ...
            if (coll != null) {
                ...
                if (!charsetNameToCollationIndexMap.containsKey(charsetName)
                        || charsetNameToCollationPriorityMap.get(charsetName) < coll.priority) {
                ...
                if (charsetName.equals(MYSQL_CHARSET_NAME_ucs2)
                        || charsetName.equals(MYSQL_CHARSET_NAME_utf16)
                        || charsetName.equals(MYSQL_CHARSET_NAME_utf16le)
        ...
        COLLATION_NAME_TO_COLLATION_INDEX = Collections
                .unmodifiableMap(collationNameToCollationIndexMap);
    ...
    protected static String getStaticMysqlCharsetForJavaEncoding(String javaEncoding,
        ...
        if (mysqlCharsets != null) {
            ...
            for (MysqlCharset charset : mysqlCharsets) {
                if (charset.isOkayForVersion(version) && (currentChoice == null
                        || currentChoice.minimumVersion.compareTo(charset.minimumVersion) < 0
                        || currentChoice.priority < charset.priority && currentChoice.minimumVersion
    ...
    protected static String getStaticJavaEncodingForCollationIndex(Integer collationIndex,
        ...
        return charset != null ? charset.getMatchingJavaEncoding(fallbackJavaEncoding)
                : fallbackJavaEncoding;
    }
...
class MysqlCharset {
    ...
    public MysqlCharset(String charsetName, int mblen, int priority, String[] javaEncodings,
        ...
        for (int i = 0; i < javaEncodings.length; i++) {
            ...
            try {
                ...
                // if there is no support of this charset in JVM it's still possible to use our converter for 1-byte
                // charsets
                if (mblen == 1) {
    ...
    String getMatchingJavaEncoding(String javaEncoding) {
        if (javaEncoding != null
                && this.javaEncodingsUc.contains(javaEncoding.toUpperCase(Locale.ENGLISH))) {
            return javaEncoding;
        }
